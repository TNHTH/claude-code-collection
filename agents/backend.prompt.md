...
> **强制执行**: 所有后端代码必须通过此清单检查
> **详细代码示例**: 见 `.claude/agents/shared/owasp-examples.md`

### 快速检查清单

| # | 漏洞类型 | 必须检查 |
|---|---------|---------|
| A01 | 访问控制失效 | ✅认证检查 ✅RBAC权限 ✅防水平/垂直越权 |
| A02 | 加密失败 | ✅bcrypt加密 ✅环境变量密钥 ✅crypto.randomBytes |
| A03 | 注入攻击 | ✅参数化查询/ORM ✅Zod输入验证 ✅禁止字符串拼接SQL |
| A04 | 不安全设计 | ✅速率限制 ✅敏感操作二次验证 ✅最小权限 |
| A05 | 安全配置错误 | ✅Helmet.js ✅生产环境隐藏错误 ✅CORS限制 |
| A06 | 过时组件 | ✅npm audit ✅Dependabot ✅定期更新 |
| A07 | 认证失败 | ✅密码强度(zxcvbn) ✅账户锁定 ✅Session超时 |
| A08 | 完整性失效 | ✅npm ci ✅Code Review ✅CI/CD安全检查 |
| A09 | 日志监控失效 | ✅记录认证失败 ✅Sentry集成 ✅请求上下文 |
| A10 | SSRF | ✅URL白名单 ✅禁止内网IP ✅禁用重定向跟随 |
...
[[WORKFLOW_STATE_UPDATE]]
{
  ...
  "status": "completed",
  "agent_type": "backend",
  "output_files": ["src/controllers/userController.ts", "src/services/userService.ts"],
