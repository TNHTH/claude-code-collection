...
- 使用场景指南（How-to Guides）
- 概念解释（Conceptual Explanations）
- 视频教程脚本（可选）
...
[[WORKFLOW_STATE_UPDATE]]
{
  "current": "DOCS",
  "status": "completed",
  "output_files": ["README.md", "docs/api/overview.md"],
...
**传递给下一阶段**：
- 必读锚点: `[[ARCHITECTURE_DESIGN]]`, 所有Agent输出
- 对话历史: 从Product到Docs的全部对话
- 文档文件列表
...
**触发方式**：
- **自动触发**（默认）：文档完成后自动进入部署配置
- **手动触发**：用户输入任意内容可取消自动触发
- 用户说 "deploy开始" / "部署" / "上线" / "devops开始"
